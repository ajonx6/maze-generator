...
public class AStarStyles implements SearchAlgorithmStyles {
	...
	public AStarStyles(int currentCellFloor, int currentCellWall, int queuedCellFloor, int queuedCellWall, int seenCellFloor, int seenCellWall, int pathCellFloor, int pathCellWall) {
