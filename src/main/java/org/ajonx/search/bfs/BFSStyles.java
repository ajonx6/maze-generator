...
public class BFSStyles implements SearchAlgorithmStyles {
	...
	public BFSStyles(int currentCellFloor, int currentCellWall, int queuedCellFloor, int queuedCellWall, int seenCellFloor, int seenCellWall, int pathCellFloor, int pathCellWall) {
