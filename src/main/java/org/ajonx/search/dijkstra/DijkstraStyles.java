...
public class DijkstraStyles implements SearchAlgorithmStyles {
	...
	public DijkstraStyles(int currentCellFloor, int currentCellWall, int queuedCellFloor, int queuedCellWall, int seenCellFloor, int seenCellWall, int pathCellFloor, int pathCellWall) {
