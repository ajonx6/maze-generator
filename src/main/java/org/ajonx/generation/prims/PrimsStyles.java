...
public class PrimsStyles implements MazeGeneratorStyles {
	...
	public PrimsStyles(int currentCellFloor, int currentCellWall, int candidateCellFloor, int candidateCellWall, int backtrackFloor, int backtrackWall) {
